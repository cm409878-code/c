...
if pagina == "Início":
    ...
    with a1:
        st.markdown(
            '<div class="feature-card"><h3>Quando procurar avaliação?</h3><p>Queda das pálpebras, excesso de pele, lacrimejo, irritação ocular, assimetrias ou alterações do olhar.</p></div>',
            unsafe_allow_html=True
        )

    with a2:
        st.markdown(
            '<div class="feature-card"><h3>O que pode afetar as pálpebras?</h3><p>Ptose, excesso de pele, bolsas, lesões palpebrais, entrópio, ectrópio e alterações estéticas perioculares.</p></div>',
            unsafe_allow_html=True
        )

    with a3:
        st.markdown(
            '<div class="feature-card"><h3>Vias lacrimais</h3><p>Alterações da drenagem da lágrima podem causar lacrimejo persistente, infeções e desconforto ocular.</p></div>',
            unsafe_allow_html=True
        )
